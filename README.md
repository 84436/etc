...
- `windows-recovery-customized`: A bunch of tiny scripts and configuration files to create a _minimally modified_ WinPE image off of the original WinRE (Windows Recovery) image.
