...
SET IMAGE_NAME=Windows IoT Enterprise LTSC
SET VERSION_BASE=19044.1288
SET VERSION_TARGET=
SET VERSION_KB=
...
TITLE * Add Servicing Stack Update (KB5014032)
DISM /Image:%WORKSPACE_DRIVE% /Add-Package ^
    /PackagePath:"KB5014032-19041.1704-SSU.msu"
